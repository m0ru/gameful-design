...
Not in the video: The measured dance-activity can be used to determine the songs that work well. Also the avatars could be used for merchantising ("your avatar and the band's avatars as a print") which could be gifted to the hardest rocking fans for free as an incentive.
...
In general I find the idea to use the cards' focus very appealing. Tools like these tend to direct the search of the design space away from the well trodden paths and over-done solutions.
